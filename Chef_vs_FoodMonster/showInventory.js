class showInventory extends Phaser.Scene {
  ...
  create(){
    ...
    this.scene.bringToTop(showInventory)
      ...
      this.keyimg1 = this.add.image (50,50,'Keyimg').setScrollFactor(0).setVisible(false).setScale(0.5);
      this.keyimg2 = this.add.image (100,50,'Keyimg').setScrollFactor(0).setVisible(false).setScale(0.5);
      this.keyimg3 = this.add.image (150,50,'Keyimg').setScrollFactor(0).setVisible(false).setScale(0.5);
      this.keyimg4 = this.add.image (200,50,'Keyimg').setScrollFactor(0).setVisible(false).setScale(0.5);
      this.keyimg5 = this.add.image (250,50,'Keyimg').setScrollFactor(0).setVisible(false).setScale(0.5);
      this.keyimg6 = this.add.image (300,50,'Keyimg').setScrollFactor(0).setVisible(false).setScale(0.5);
