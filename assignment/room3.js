class room3 extends Phaser.Scene {
    ...
    this.physics.add.collider(this.player,this.buildingLayer);
      ...
      this.physics.add.overlap(this.player, this.orange,this.collect_antidote,null);
      this.physics.add.overlap(this.player, this.blue,this.collect_antidote,null);
      this.physics.add.overlap(this.player, this.yellow,this.collect_antidote,null);
      this.physics.add.overlap(this.player, this.green,this.collect_antidote,null);
    }
